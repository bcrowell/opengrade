...
There are two methods, described below, for installing OpenGrade on Windows.

\mysubsection{Windows, prepackaged program}
The first is to simply download and
run the prepackaged program from the web page. I don't yet have any feedback from Windows users
who have actually tested this on a Windows machine; I have only tested it myself on Linux using
the Wine emulator.

\mysubsection{Windows, ActivePerl}
If the prepackaged program doesn't work for you, you can try the following procedure,
wich involves installing a free version of Perl, called ActivePerl.
