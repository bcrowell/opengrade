...
\mysection{User-defined Extensions}\label{extensions}
...
The string \verb@* x 0.1@ is a snippet of code written in a dialect of the
programming language Lisp. The dialect is called Guile. Guile is a standard
extension language for linux software, and most linux machines will already
have Guile installed. If you want to check whether Guile is installed on
your machine, you can try this from the command line, and the result should
be that it prints 4:

\verb@guile -c "(display(+ 2 2))"@

Getting back to our example, the star is a multiplication
operator, and it's prefixed to the operands. That is, the expression in this
code snippet is what you would enter on a calculator as \verb@x*0.1@, meaning
to multiply x by 0.1.
